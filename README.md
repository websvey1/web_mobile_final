...
2. **Header**
    ...
    * **Post**
      ...
      ![](.\images\header_post.PNG)
    
      ![](.\images\header_post2.PNG)
...
3. **개인 Project (Project 명세서 관리, Post, To Do List, Calendar)**
  ...
  * Header에서 보이지 않던 비밀 Post를 작성자는 확인 할 수 있다.
   ...
   * **Calendar**
     ...
     * 일정의 Title, Start date, Eed date, Event description을 작성할 수 있으며 자신이 원하는 color(THEME)를 선택할 수 있다.
     * 확인하고 싶은 일정을 누르면 모달로 일정의 정보를 확인, 수정, 삭제 할 수 있다
